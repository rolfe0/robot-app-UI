...
st.title("🤖 我的面板機器人")
st.write("目前狀態：🟢 動畫速度已調慢至 0.05 慢動作播放中。")
...
if os.path.exists(model_filename):
    ...
    # 3. 嵌入 Google 3D 渲染器（將 time-scale 設定為 0.05）
    html_code = f"""
    ...
    <script>
        const modelViewer = document.querySelector("#super-slow-robot");
    ...
    st.success("🟢 網頁 3D 核心已更新至 0.05 倍速！")
